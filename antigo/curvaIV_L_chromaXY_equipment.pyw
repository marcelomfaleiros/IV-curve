...
class Measurement(qtw.QMainWindow, Ui_MainWindow):
    ...
    def graph_start(self):
        ...
        #self.iv_graphicsView.setGraphCursor(flag=False, color='black', linewidth=1, linestyle='-')
    ...
    def start_up(self):       
        ...
        ocean_list = sb.spectrometers.list_devices()
        self.oceanport_label.setText(str(ocean_list))        
        ...
        com_p = self.com_ports()
        self.lineEdit.setText(com_p)
        self.chroma.rs232_set_up(com_p)            
